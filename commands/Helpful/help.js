...
module.exports = {
  ...
  run: async (bot, message, args) => {
    ...
    .setDescription("**✅ Version**: 2.0.5\n \n**⬆️ Last Update**: Unjail command, less messier code, and jokewarn command!")
    ...
    .setColor("RANDOM")
    .setTitle("Support")
    .setDescription("Need help? Want to suggest something? DM me! A staff member will get back to you ASAP!")
